...
def main():
    ...
    parser.add_argument('--datadir',type=str,default='./embeds/cora_all_embs.npy',help='data dir')
    parser.add_argument('--labeldir',type=str,default='./embeds/cora_all_ps_labels.npy',help='label dir')
